...
def backtest(data, signals, loss_threshold):
    prev_date = None
    ...
    for date in data.index:
        ...
        holdings, total_realized_pnl, total_unrealized_pnl = close_positions(cur_price, holdings, loss_threshold, date, histogram)
